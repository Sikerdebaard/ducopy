...
def client() -> AIORestClient:
    ...
    client = AIORestClient(base_url=base_url, verify=True)  # SSL verification enabled
    yield client


@pytest.fixture(scope="module")
def client_insecure() -> AIORestClient:
    ...
    base_url = f"https://{duco_ip}"
    client = AIORestClient(base_url=base_url, verify=False)  # SSL verification disabled
    yield client


def test_get_api_info(client: AIORestClient) -> None:
...
# def test_get_api_info_insecure(client_insecure: AIORestClient) -> None:
#     """Test fetching API info without SSL verification."""
#     api_info = client_insecure.get_api_info()
#     assert isinstance(api_info, dict), "API info response should be a dictionary"


# def test_get_nodes(client: AIORestClient) -> None:
...
# def test_get_nodes_insecure(client_insecure: AIORestClient) -> None:
...
# def test_get_node_info(client: AIORestClient) -> None:
...
# def test_get_node_info_insecure(client_insecure: AIORestClient) -> None:
...
# def test_get_config_node(client: AIORestClient) -> None:
...
# def test_get_config_node_insecure(client_insecure: AIORestClient) -> None:
...
# def test_get_logs(client: AIORestClient) -> None:
...
# def test_get_logs_insecure(client_insecure: AIORestClient) -> None:
#     """Test fetching API logs without SSL verification."""
#     logs_response = client_insecure.get_logs()
#     assert isinstance(logs_response, dict), "Logs response should be a dictionary"


# def test_get_actions_node(client: AIORestClient) -> None:
...
# def test_get_actions_node_insecure(client_insecure: AIORestClient) -> None:
