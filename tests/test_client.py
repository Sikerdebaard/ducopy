...
def test_get_nodes(client: APIClient, mock_requests: requests_mock.Mocker) -> None:
    ...
    nodes_response = NodesInfoResponse(
        **mock_data
    )  # Instantiate NodesInfoResponse directly with data
...
def test_post_action_node(
    ...
    action_response = ActionsChangeResponse(
        **mock_data
    )  # Instantiate ActionsChangeResponse directly with data
...
def test_get_config_node(
    ...
    config_response = ConfigNodeResponse(
        **mock_data
    )  # Instantiate ConfigNodeResponse directly with data
...
def test_get_actions_node(
    ...
    actions_response = ActionsResponse(
        **mock_data
    )  # Instantiate ActionsResponse directly with data
